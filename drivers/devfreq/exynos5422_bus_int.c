...
#if 1  // modified by yunwu 20160408	
					...
					unsigned long target_freq, unsigned long pre_freq)
{
	...
	for (i = LV_0; i < LV_END; i++) { // added by yunwu 20160409
...
///////// added by yunwu 20160409 /////////////////
struct userspace_data {
	unsigned long user_frequency;
	bool valid;
};
struct userspace_data exynos5_int_governor_data_userspace = {
	.user_frequency = 600000,
	.valid = true,
};
////////////////////////////////////////////////
...
static int exynos5_devfreq_int_probe(struct platform_device *pdev)
{
	...
	data->devfreq = devfreq_add_device(dev, &exynos5_int_devfreq_profile,
			"userspace", &exynos5_int_governor_data_userspace/*NULL*/); // modified by yunwu 20160409
#endif
#if defined(CONFIG_DEVFREQ_GOV_SIMPLE_ONDEMAND)
	data->devfreq = devfreq_add_device(dev, &exynos5_int_devfreq_profile,
...
//////////////// added by yunwu 20160408 /////////
	rcu_read_lock();
	data->devfreq->max_freq = 600000;
	data->devfreq->min_freq = 83000;
	rcu_read_unlock();
///////////////////////////////////////////////////
	...
	//clk_enable(data->fout_spll); // modified by yunwu 20160408
	//data->spll_enabled = true; // modified by yunwu 20160408
