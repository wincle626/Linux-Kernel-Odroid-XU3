cmd_scripts/pnmtologo := gcc -Wp,-MD,scripts/.pnmtologo.d -Wall -Wmissing-prototypes -Wstrict-prototypes -O2 -fomit-frame-pointer -std=gnu89   -I/root/odroidxu3-3.10.y/tools/include  -o scripts/pnmtologo scripts/pnmtologo.c  
