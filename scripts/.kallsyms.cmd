cmd_scripts/kallsyms := gcc -Wp,-MD,scripts/.kallsyms.d -Wall -Wmissing-prototypes -Wstrict-prototypes -O2 -fomit-frame-pointer -std=gnu89   -I/root/odroidxu3-3.10.y/tools/include  -o scripts/kallsyms scripts/kallsyms.c  
